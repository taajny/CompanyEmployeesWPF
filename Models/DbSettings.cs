...
{
    public class DbSettings : ViewModelBase, IDataErrorInfo
    {
        public DbSettings()
        {
        ...
        public void Save()
        {
            Properties.Settings.Default.dbServerAddress = dbServerAddress;
            Properties.Settings.Default.dbServerName = dbServerName;
            Properties.Settings.Default.dbName = dbName;
            Properties.Settings.Default.dbUserName = dbUserName;
